...
class ListEstablishmentTest(TestCase):
    ...
    def setUp(self):
        ...
        band2 = Band.objects.create(name="metallica", web_link='https://soundcloud.com/tessatioarina', playlist='https://soundcloud.com/dj-elye/sets/jazz', email="tessatioarina@gmail.com", mobile="100000000", user=user2)
        band3 = Band.objects.create(name="Maravillosa Orquesta del Alchol", web_link='https://soundcloud.com/drei-jazz', playlist='https://soundcloud.com/dj-elye/sets/jazz',     email="tessatioarina@gmail.com", mobile="200000000", user=user3)
        band4 = Band.objects.create(name="Oques Grasses", web_link='https://soundcloud.com/angelo-mikha', playlist='https://soundcloud.com/dj-elye/sets/jazz',  email="angelo@gmail.com", mobile="300000000", user=user4)
        ...
        ev2 = Event(name='Acampada Jove', state='CL', date=date2, description="Short Description", establishment=est2)
        ev2.save()
        ev2.band.add(band1, band4)
        ev3 = Event(name='Festiuet', state='SR', date=date3, description="Short Description", establishment=est3)
        ev3.save()
        ev3.band.add(band1, band2)
        ev4 = Event(name='Ressurection fest', state='CL', date=date4, description="Short Description", establishment=est4)
        ev4.save()
